...
/** Compara pelo IdViveiro em ordem decrescente.
 * Obs: Aparentemente não funciona.
 * @version 0.8
 * @author Artur Schaefer
 *
 */
public class ComparatorMudaPorIdViveiroDecrescente implements Comparator<Muda> {
    /**
     * 
